...
<p>Here at {{ $user->compName }}, while we were conducting some research for the position of {{$user->position_sec}} in {{$user->position_main}} , we came across your profile. </p>
